...
let imagenExcusa = [
 ...
 'https://images.ecestaticos.com/ma-8-qxW5do1IPv1-OUj5Z11KuA=/2x112:2271x1388/1600x900/filters:fill(white):format(jpg)/f.elconfidencial.com%2Foriginal%2F113%2Fac0%2Fac0%2F113ac0ac08a602c6b4c82b8702ad9279.jpg',
 'https://i.pinimg.com/236x/f2/e5/f3/f2e5f34cdb26c1705b48012b46adab15.jpg', 
];


window.onload = function() {
const boton= document.getElementById('botonExcusa');
boton.addEventListener('click', generarNuevaExcusa);


//*formato anterior de la excusa
/*
let excusaGenerada =
...
function generarNuevaExcusa() {let excusaGenerada =
elementoaleatorio(who) + ' ' +
elementoaleatorio(action) + ' ' +
elementoaleatorio(what) + ' ' +
elementoaleatorio(when) + '.';
